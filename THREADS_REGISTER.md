...
| PRE_REG_015 | Climate-attribution USA 3a-3b | **locked + Sets A/C/E SUPPORTED** | 2026-05-27 | Set A CONSISTENT (mega-year freq 7.1%→17.6%); **Set C SUPPORTED: r(USA storm-IDP, Atlantic ACE) = +0.552 on n=6**; **Set E SUPPORTED: CUB replicates intensification (7.1%→17.6% abs, +21% per-capita); PRI inconclusive-by-artifact (Maria displacement = off-island emigration not IDP); F5 NOT FIRED**; Set B (SST × IDP) DEFERRED (HadISST stops 2003). F3 NOT FIRED. See digs 2026_05_27_hadisst_hurdat_ace_partial_fit.md + 2026_05_27_prereg015_setE_cub_pri.md |
